...
<p><strong>Code computes, Jev judges.</strong> Jev never generates text or notes. It picks from options that code enumerated, so it cannot write an illegal note, a bar that does not add up, or a chord outside the key. What it can do is prefer.</p>
<ol>
...
<li><strong>Cadences and repeats, no call.</strong> The last bar of every phrase holds the closing degree, tonic or dominant. The answering phrase repeats the opening phrase bar for bar except that last bar, and the return repeats the answer. Repetition is what makes sixteen bars of choices sound like a song.</li>
</ol>
...
<li><strong>Mood reaches the music.</strong> “Wistful, late night” came back minor at 100% confidence and 72 bpm; “playful, skipping down the street” came back major at 100% and 120 bpm in skipping eighths. “Restless, pacing the room at midnight” made Jev open on the diminished chord, the one tense chord in the key, which code's own ranking had put last of seven. In testing, “jazz” walked ii–V–I in sevenths and “bossa nova” split the mode almost evenly, which is fair. Tempo answers are softer, 30% to 90%, so pin the tempo if you care.</li>
...
<p>The whole project is open source: <a href="https://github.com/beingcognitive/jev-songwriter"><strong>github.com/beingcognitive/jev-songwriter</strong></a> — MIT, no dependencies, and the JSON trace of every call on this page is in the repository too.</p>
<pre>npm test
